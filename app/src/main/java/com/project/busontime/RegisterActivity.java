            ...
            public void onClick(View v) {
                if (!userName.getText().toString().isEmpty()
                    ...
                    if (userPass.getText().toString().length()>=8) {
                        ...
                        userO.setApproved(false);
                        userO.setLicenseNumber(userLicense.getText().toString());
                        userO.setUserEmail(userEmail.getText().toString());
                        userO.setUserName(userName.getText().toString());
                        userO.setUserGuid(UUID.randomUUID().toString());
                        mDbRef.child("users").child(userO.getUserGuid()).setValue(userO);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            startActivity(new Intent(RegisterActivity.this, RoutesActivity.class));
